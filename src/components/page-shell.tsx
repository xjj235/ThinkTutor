...
export function EmptyState({ title, description }: { title: string; description: string }) { return <div className="empty-state"><Inbox size={30} strokeWidth={1.4} aria-hidden="true" /><h2>{title}</h2><p>{description}</p></div>; }
